...
The public-prep builder strips saved WiFi profiles, SSH host keys, and machine-id from its input image, keeps `sshd` enabled, and can optionally inject a user-provided WiFi profile before flashing.
